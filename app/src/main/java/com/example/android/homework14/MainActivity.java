package com.example.android.homework14;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View engeneerBar = findViewById(R.id.engineer_bar);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mathBar.getVisibility() == View.VISIBLE){
                    ...
                    engeneerBar.setVisibility(View.VISIBLE);
                    button.setText(R.string.engeneer_mode);
                } else {
                    mathBar.setVisibility(View.VISIBLE);
                    engeneerBar.setVisibility(View.GONE);
